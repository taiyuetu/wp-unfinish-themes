  ...
  <div class="container">
    <div class="about-hero__layout">
      <div class="about-hero__content">
        <div class="tag reveal visible">Since 2001</div>
        <h2 class="about-hero__title reveal reveal-delay-1 visible">
          Engineering <span>Precision</span> in Motion
        </h2>
        <p class="about-hero__desc reveal reveal-delay-2 visible">
          Axiom Drive is a global Tier-1 manufacturer of precision wheel hub assemblies, serving leading automotive OEMs and Tier-1 suppliers across four continents. With over two decades of engineering excellence, we deliver components that define industry standards for reliability and performance.
        </p>
        <a href="contact.html" class="btn-primary reveal reveal-delay-3 visible">
      ...
      <div class="about-hero__visual reveal visible">
        <span style="position:absolute;bottom:12px;right:12px;font-family:var(--f-mono);font-size:9px;letter-spacing:.15em;text-transform:uppercase;color:var(--c-steel-mid);padding:4px 8px;border:1px solid var(--c-border);background:rgba(8,10,12,.6);z-index:1;">IMAGE: 512px × 400px</span>
        <div class="about-hero__visual-badge">
          <span class="about-hero__visual-badge-value">24+</span>
          <span class="about-hero__visual-badge-label">Years of Excellence</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="capabilities" id="capabilities" aria-labelledby="capabilities-title">
    <div class="container">
      <div class="capabilities__header">
        <div>
          <div class="tag reveal" style="margin-bottom:20px">Core Capabilities</div>
          <h2 class="section-title reveal reveal-delay-1" id="capabilities-title">
            Built for<br><span>Demanding</span><br>Applications
          </h2>
        </div>
        <p class="capabilities__intro reveal reveal-delay-2">
          Axiom Drive operates <strong>three dedicated manufacturing facilities</strong> spanning 180,000 m², equipped
          with closed-loop forging presses, 5-axis CNC machining centers, and fully automated assembly lines. Every unit
          exits through our <strong>multi-stage zero-defect protocol</strong> before shipment.
        </p>
      </div>
      ...
      <div class="capabilities__grid">
        ...
        <div class="capability-card reveal">
          ...
          <div class="capability-card__number">01</div>
          <div class="capability-card__title">Precision Forging</div>
          <p class="capability-card__text">Closed-die hot forging with automated flash trimming. Bearing-grade steel
            blanks with controlled metallurgical properties.</p>
          <div class="capability-card__metric">4,500<span style="font-size:16px;color:var(--c-chrome)">T</span></div>
          <div class="capability-card__metric-label">Max Press Capacity</div>
        </div>
        <!-- Card 2 -->
        <div class="capability-card reveal reveal-delay-1">
          ...
          <div class="capability-card__number">02</div>
          <div class="capability-card__title">CNC Machining</div>
          <p class="capability-card__text">48 machining centers operating 24/7. Sub-micron tolerances on bearing
            surfaces. Hard turning and grinding for final geometry.</p>
          <div class="capability-card__metric">±2µm</div>
          <div class="capability-card__metric-label">Bearing Race Tolerance</div>
        </div>
        <!-- Card 3 -->
        <div class="capability-card reveal reveal-delay-2">
          ...
          <div class="capability-card__number">03</div>
          <div class="capability-card__title">Heat Treatment</div>
          <p class="capability-card__text">Controlled atmosphere carburizing and induction hardening. Optimised case
            depth profiles for fatigue resistance and load rating.</p>
          <div class="capability-card__metric">62<span style="font-size:16px;color:var(--c-chrome)">HRC</span></div>
          <div class="capability-card__metric-label">Surface Hardness</div>
        </div>
        <!-- Card 4 -->
        <div class="capability-card reveal reveal-delay-3">
          ...
          <div class="capability-card__number">04</div>
          <div class="capability-card__title">Assembly & Testing</div>
          <p class="capability-card__text">Automated assembly cells with 100% torque verification, ABS encoder ring
            integration, and end-of-line noise testing.</p>
          <div class="capability-card__metric">100%</div>
          <div class="capability-card__metric-label">End-of-Line Inspection</div>
        </div>
      </div>
    </div>
  </section>
